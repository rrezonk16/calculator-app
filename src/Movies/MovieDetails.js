              ...
              <div className="relative  w-full md:w-2/5 mx-auto my-6">
                <div className="relative flex flex-col w-full bg-white border-0 rounded-2xl shadow-lg outline-none focus:outline-none">
                  ...
                  <div className="flex items-start justify-between p-5 border-b border-solid border-blueGray-200 rounded-t">
                    <h3 className="text-3xl font-semibold">"{movieData.title}" Trailer</h3>
                  ...
                  <div className="flex items-center justify-end p-4 border-t border-solid border-blueGray-200 rounded-b">
                    <button
                      ...
                      className="text-white hover:bg-red-900 bg-red-600 rounded-3xl font-bold uppercase px-6 py-2 text-sm outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                    >
                      Close
                    </button>
                  </div>
